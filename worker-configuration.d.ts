/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aef92136a59a8711f6a065c3e14dc6f8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CACHEABLE_COOKIE_NAMES: string;
		CACHEABLE_MIME_TYPES: string;
		ORIGIN_HOST: string;
		DEBUG: string;
		RETURN_CLAIMS: string;
		REPLACE_ORIGIN_LINKS: string;
		DETECT_MERGED_STYLES_CHANGE: string;
		MERGED_STYLES_CHECK_TTL_SECONDS: string;
		PURGE_SECRET: string;
	}
}
